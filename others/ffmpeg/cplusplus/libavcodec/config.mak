...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=arm --cc= --disable-doc --disable-debug --disable-avdevice --disable-devices --disable-avfilter --disable-swresample --disable-swresample --disable-filters --disable-bsfs --disable-bzlib --disable-programs --disable-avresample --disable-encoders --disable-muxers --disable-asm --prefix=./android/armv7-a --enable-cross-compile --cpu=armv7-a --sysroot=/usr/lib/android-ndk/platforms/android-19/arch-arm/ --cc=/usr/lib/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc --cross-prefix=/usr/lib/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86_64/bin/arm-linux-androideabi- --nm=/usr/lib/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86_64/bin/arm-linux-androideabi-nm --disable-yasm --disable-shared --enable-static --disable-everything --disable-programs --disable-parsers --enable-version3 --prefix=../build/ffmpeg/armeabi-v7a --extra-cflags='-march=armv7-a -mfloat-abi=softfp -fPIC -DANDROID' --extra-ldflags=
