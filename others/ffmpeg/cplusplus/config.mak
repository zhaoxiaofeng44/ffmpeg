...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=arm --cc= --disable-everything --disable-avdevice --disable-ffmpeg --disable-ffserver --disable-ffplay --disable-filters --disable-devices --disable-encoders --disable-avfilter --disable-postproc --disable-doc --disable-debug --disable-devices --disable-avresample --disable-muxers --disable-yasm --disable-asm --prefix=./android/armv7-a --enable-cross-compile --cpu=armv7-a --sysroot=/usr/lib/android-ndk/platforms/android-19/arch-arm/ --cc=/usr/lib/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc --cross-prefix=/usr/lib/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86_64/bin/arm-linux-androideabi- --nm=/usr/lib/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86_64/bin/arm-linux-androideabi-nm --disable-shared --enable-static --enable-version3 --enable-gpl --disable-network --enable-bsfs --enable-demuxers --enable-parsers --enable-decoder='h264,mpeg4' --enable-protocol=file --enable-pic --enable-small --enable-hwaccels --prefix=../build/jni/armeabi-v7a --extra-cflags='-march=armv7-a -mfloat-abi=softfp -fPIC -DANDROID' --extra-ldflags=
prefix=../build/jni/armeabi-v7a
...
ARCH=c
CC=/usr/lib/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
CXX=/usr/lib/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86_64/bin/arm-linux-androideabi-g++
AS=/usr/lib/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
LD=/usr/lib/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
DEPCC=/usr/lib/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/usr/lib/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=/usr/lib/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86_64/bin/arm-linux-androideabi-ar
ARFLAGS=rc
AR_O=$@
RANLIB=/usr/lib/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86_64/bin/arm-linux-androideabi-ranlib
STRIP=/usr/lib/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86_64/bin/arm-linux-androideabi-strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/usr/lib/android-ndk/platforms/android-19/arch-arm/ -isysroot /usr/lib/android-ndk/platforms/android-19/arch-arm/ -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC
CFLAGS=  -march=armv7-a -mfloat-abi=softfp -fPIC -DANDROID -march=armv7-a -std=c99 -fomit-frame-pointer -fPIC -marm -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -march=armv7-a -mfloat-abi=softfp -fPIC -DANDROID -march=armv7-a -fPIC
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
WINDRES=/usr/lib/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86_64/bin/arm-linux-androideabi-windres
DEPWINDRES=/usr/lib/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc
LDFLAGS=   --sysroot=/usr/lib/android-ndk/platforms/android-19/arch-arm/ -isysroot /usr/lib/android-ndk/platforms/android-19/arch-arm/ -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
